...
if ENV:
    ...
    BAN_STICKER = os.environ.get("BAN_STICKER", "CAACAgQAAxkBAAI3WGLYAYX5XKnLC_exxJ4ZCit2_EaaAAIcDgACFcGoU01-gUHYLoq3KQQ")
...
from Goku.modules.helper_funcs.handlers import (
